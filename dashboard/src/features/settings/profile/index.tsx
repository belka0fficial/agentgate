...
const sections = [
  ...
  },
  {
    ...
    description: 'Theme and visual preferences for the local dashboard.',
    icon: Palette,
    status: 'existing',
  },
  {
    ...
    description: 'Notification preferences for local alerts and owner attention.',
    icon: Bell,
    status: 'existing',
  },
  {
    ...
    description: 'Density, layout, and screen presentation preferences.',
    icon: Monitor,
    status: 'existing',
  },
]
